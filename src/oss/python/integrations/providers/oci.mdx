...
See [chat](/oss/integrations/llms/oci_generative_ai), [complete](/oss/integrations/chat/oci_generative_ai), and [embedding](/oss/integrations/text_embedding/oci_generative_ai) usage examples.
...
See [chat](/oss/integrations/chat/oci_data_science) and [complete](/oss/integrations/llms/oci_model_deployment_endpoint) usage examples.

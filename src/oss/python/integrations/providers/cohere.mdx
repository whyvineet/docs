...
Usage of the Cohere [chat model](/oss/integrations/chat/cohere)
...
Usage of the Cohere (legacy) [LLM model](/oss/integrations/llms/cohere)
...
Usage of the Cohere [RAG Retriever](/oss/integrations/retrievers/cohere)
...
Usage of the Cohere [Text Embeddings model](/oss/integrations/text_embedding/cohere)

### Reranker

Usage of the Cohere [Reranker](/oss/integrations/retrievers/cohere-reranker)

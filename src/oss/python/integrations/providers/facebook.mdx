...
See a [usage example](/oss/integrations/text_embedding/laser).
...
See a [usage example](/oss/integrations/document_loaders/facebook_chat).
...
See a [usage example](/oss/integrations/vectorstores/faiss).
...
See a [usage example](/oss/integrations/chat_loaders/facebook).

...
You can also find Zep Open Source compatible [Retriever](/oss/integrations/retrievers/zep_memorystore), and [Vector Store](/oss/integrations/vectorstores/zep) examples.
...
See a [usage example](/oss/integrations/retrievers/zep_cloud_memorystore).
...
See a [usage example](/oss/integrations/vectorstores/zep_cloud).

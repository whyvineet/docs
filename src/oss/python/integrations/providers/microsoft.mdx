...
See the documentation [here](/oss/integrations/chat/azureml_chat_endpoint) for accessing chat
...
queries at scale. See [here](/oss/integrations/vectorstores/azuresearch) for usage examples.
...
See the instructions [here](/oss/integrations/tools/azure_dynamic_sessions/#setup).
...
Follow the documentation [here](/oss/integrations/tools/bing_search) to get a detail explanations and instructions of this tool.

...
Next, define a function that maps Apify dataset record fields to LangChain @[`Document`] format.
...
For more information, see the [LangChain MCP documentation](/oss/langchain/mcp).
